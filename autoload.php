...
require_once __DIR__.'/classes/model.api.result.object.class.php';
require_once __DIR__.'/classes/model.api.class.php';
...
require_once __DIR__.'/classes/controller.cron.class.php';
